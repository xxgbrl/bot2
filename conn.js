...
const isOwner = [`${setting.ownerNumber}`,"6285156980508@s.whatsapp.net","6288980080796@s.whatsapp.net"].includes(sender) ? true : false
...
*_Seputar gabStore & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin 1 : 088980080796_
_Admin 2 : 085156980508_
...
const gurbot = '6288980080796@s.whatsapp.net'
...
var bg_lexxy = '6285156980508@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© edited by gabStorel' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: '6.6.6', author: 'gabStore' }
...
var dev = '6285156980508@s.whatsapp.net'
